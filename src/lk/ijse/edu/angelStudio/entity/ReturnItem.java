...
public class ReturnItem {
   ...
   private String   damages  ; 
    ...
    public ReturnItem(String rid, String cid, String oid, String caid, String name, String NIC, String brand, String LenseBrand, String LenseSize, double price, int qty, double fullTotal, double payAmount, double blance, String damages) {
        this.rid = rid;
        this.cid = cid;
        this.oid = oid;
        this.caid = caid;
    ...
    public String toString() {
        return "ReturnItem{" + "rid=" + rid + ", cid=" + cid + ", oid=" + oid + ", caid=" + caid + ", name=" + name + ", NIC=" + NIC + ", brand=" + brand + ", LenseBrand=" + LenseBrand + ", LenseSize=" + LenseSize + ", price=" + price + ", qty=" + qty + ", fullTotal=" + fullTotal + ", payAmount=" + payAmount + ", blance=" + blance + ", damages=" + damages + '}';
    }
